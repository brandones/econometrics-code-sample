...
data <- read_csv("./wits-with-complexity.csv")
...
write_csv(export_data, "./output/real_resource_dependency.csv", na = "")
...
write_csv(annual_data, "./output/real_resource_dependency_annual.csv", na = "")